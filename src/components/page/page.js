...
const Faqs = fromJS([
	...
	{
		question: 'What schools and artists have you worked with?',
		answer: `This is the answer to the question highlighted on the left. This will dynamically change based on the question selected. Think of this element as vertical tabs. Payoff bankroll convention center vdara sin city flush; chips flamingo hotel town square treasure island?
		Chateau the pairs royal flush baccarat the excalibur swim-up blackjack sin city? All in chateau the venetian swim-up blackjack veer towers flush, draw fruit loop odds fremont street! Haze two pair exposure all in nightclubs caesar's palace zappos. Golden nugget vegas givecamp margaritaville loose parlay, push city center tease chateau. Capriotti's miracle mile shops feeling lucky town square the strip the excalibur dealer!`
	},
	{
		question: 'Wait... are you a DJ company?',
		answer: `This is the answer to the question highlighted on the left. This will dynamically change based on the question selected. Think of this element as vertical tabs. Payoff bankroll convention center vdara sin city flush; chips flamingo hotel town square treasure island?
		Chateau the pairs royal flush baccarat the excalibur swim-up blackjack sin city? All in chateau the venetian swim-up blackjack veer towers flush, draw fruit loop odds fremont street! Haze two pair exposure all in nightclubs caesar's palace zappos. Golden nugget vegas givecamp margaritaville loose parlay, push city center tease chateau. Capriotti's miracle mile shops feeling lucky town square the strip the excalibur dealer!`
	},
	{
		question: 'I already have local vendor which I like. Can we involve them in my event?',
		answer: `This is the answer to the question highlighted on the left. This will dynamically change based on the question selected. Think of this element as vertical tabs. Payoff bankroll convention center vdara sin city flush; chips flamingo hotel town square treasure island?
		Chateau the pairs royal flush baccarat the excalibur swim-up blackjack sin city? All in chateau the venetian swim-up blackjack veer towers flush, draw fruit loop odds fremont street! Haze two pair exposure all in nightclubs caesar's palace zappos. Golden nugget vegas givecamp margaritaville loose parlay, push city center tease chateau. Capriotti's miracle mile shops feeling lucky town square the strip the excalibur dealer!`
	},
	{
		question: 'What sort of equipment do you have?',
		answer: `This is the answer to the question highlighted on the left. This will dynamically change based on the question selected. Think of this element as vertical tabs. Payoff bankroll convention center vdara sin city flush; chips flamingo hotel town square treasure island?
		Chateau the pairs royal flush baccarat the excalibur swim-up blackjack sin city? All in chateau the venetian swim-up blackjack veer towers flush, draw fruit loop odds fremont street! Haze two pair exposure all in nightclubs caesar's palace zappos. Golden nugget vegas givecamp margaritaville loose parlay, push city center tease chateau. Capriotti's miracle mile shops feeling lucky town square the strip the excalibur dealer!`
	},
	{
